...
export default function LinkPage() {
  ...
  return <main className="bio-page"><div className="bio-shell">
    <header><h1>Aynı ses.<br/>Her yerde.</h1><p>Müzik, sahne ve bir sonraki buluşma.<br/>Aradığın her şey burada.</p></header>
    <div className="bio-list" aria-live="polite">
      ...
      {status === 'ready' && !links.length && <p className="bio-message">Bağlantılar yakında burada.</p>}
